...
a tag list by extracting noun phrases using nltk.
...
def usage():
    print("extract_header_tags_nltk.py:")
    ...
    print("")
    print("Usage:")
    print("    ./extract_header_tags_nltk.py [FLAGS] <path-to-markdown-files>")
    print("")
    print("        -n | --dry-run       Print the names of files that would be")
    print("                             changed if the script were run.")
    print("")
    print("Example:")
    print("    ./extract_header_tags_nltk.py ../library")
    print("")
    exit(1)
